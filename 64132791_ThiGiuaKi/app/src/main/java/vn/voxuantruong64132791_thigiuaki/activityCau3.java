    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        songAdapter.setOnItemClickListener(new SongAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(activityCau3.this, EditSongActivity.class);
            ...
            public void onDeleteClick(int position) {
                ...
                new android.app.AlertDialog.Builder(activityCau3.this)
                        .setTitle("Xóa Bài Hát")
                        .setMessage("Bạn có chắc chắn muốn xóa bài hát này không?")
                        .setPositiveButton("Có", (dialog, which) -> {
                            songAdapter.removeItem(position);
                            Toast.makeText(activityCau3.this, "Bài hát đã bị xóa", Toast.LENGTH_SHORT).show();
                        })
        ...
        btnAdd.setOnClickListener(v -> {
            ...
            if (name.isEmpty() || author.isEmpty()) {
                Toast.makeText(activityCau3.this, "Hãy điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            Toast.makeText(activityCau3.this, "Bài hát đã được thêm thành công", Toast.LENGTH_SHORT).show();
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == EDIT_SONG_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (position != -1) {
                ...
                int imageResId = data.getIntExtra("imageResId", R.drawable.default_image); // Thêm hình ảnh mặc định
